...
if __name__ == '__main__':
    ...
    ## delete the "value_" key in delexicalized responses.
    delex_responses=replaceFormats(delex_responses)
    delex_gold_responses=replaceFormats(delex_gold_responses)
