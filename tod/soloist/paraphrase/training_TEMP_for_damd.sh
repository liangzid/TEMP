...
export save_log_path="${root_dir}/log/training_for_damd_experiments.log"
# train stage.
export fraction="1.0"
export step=1000
...
do
	...
	export from_path="/home/zliang/yxp/GPU/damd/damd-multiwoz/data/dialogue/"

	$python evaluate_multiwoz.py \
	    --dataset ${dataset_name}test \
	    --model ${rate}${model_save_path}${num_id} \
	    --file ${from_path}${rate}_damd_predict_files_${num_id}.txt \
...
for prate in ${prate_list[*]};
do
    export save_model_path="${root_dir}/data/damdmt3-tempering-wta-bp_fraction1.0_prate${prate}/"
	...
	export inference_model_name="data/damdmt3-tempering-wta-bp_fraction1.0_prate${prate}/"
	export save_file_path="damdmt3-tempering-wta-bp_fraction1.0_prate${prate}_numid${num_id}.txt"
