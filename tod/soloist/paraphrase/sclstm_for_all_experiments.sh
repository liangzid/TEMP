...
# 	export save_file_path="sclstm-mt3-tempering-exp-bp_fraction1.0_prate${prate}_numid${num_id}.txt"
...
# 	export save_file_path="sclstm-mt3-tempering-wta-bp_fraction1.0_prate${prate}_numid${num_id}.txt"
