...
# 	export save_file_path="mt3-tempering-exp-bp_fraction1.0_prate${prate}_numid${num_id}.txt"
...
# 	export save_file_path="mt3-tempering-wta-bp_fraction1.0_prate${prate}_numid${num_id}.txt"
...
# for prate in ${prate_list[*]};
# do
#     export save_model_path="${root_dir}/data/mt3-tempering5-exp-bp_fraction1.0_prate${prate}/"
...
# 	export inference_model_name="data/mt3-tempering5-exp-bp_fraction1.0_prate${prate}/"
# 	export save_file_path="mt3-tempering5-exp-bp_fraction1.0_prate${prate}_numid${num_id}.txt"
...
for prate in ${prate_list[*]};
do
    export save_model_path="${root_dir}/data/mt3-tempering5-wta-bp_fraction1.0_prate${prate}/"
