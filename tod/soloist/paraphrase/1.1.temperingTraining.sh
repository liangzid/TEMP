...
export save_model_path="${root_dir}/data/save_without_bp_lr_3e-5_rate-tempering-backward/"
# export fraction_list=("0.0" "0.3" "0.4" "0.5" "0.6" "0.7")
export fraction_list=("0.7" "0.5" "0.3" "0.0")
