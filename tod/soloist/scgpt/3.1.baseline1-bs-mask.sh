...
export save_model_path="${root_dir}baseline1_bs-w-mask"
export tensorboard_path="./tensorboard-baseline1_bas-w-mask/" 

for stage in ${stage_list[*]};
do
    echo "begin to make bidirectional training for stage ${stage}"
...
# export python=/home/zliang/anaconda3/envs/soloist/bin/python3
# export save_log_path="${root_dir}/log/experiments_baseline1_add_bsmask.log"
